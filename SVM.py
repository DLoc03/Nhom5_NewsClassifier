...
tfidf_host = TfidfVectorizer(max_features=5000, ngram_range=(1, 2), max_df=0.85, min_df=5)
X_host = tfidf_host.fit_transform(X['HOSTNAME'])

tfidf_publisher = TfidfVectorizer(max_features=5000, ngram_range=(1, 2), max_df=0.85, min_df=5)
